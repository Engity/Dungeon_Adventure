...
public class CharacterTests {
    ...
    public void testNameWarrior() {
        Warrior warrior = new Warrior(50.0, 99, "Warrior", 5,99, 20, 20);
        assertEquals("testNameWarrior failed", "Warrior", warrior.getMyCharacterName());
    ...
    public void testHitNameThief() {
        Thief thief = new Thief(50.0, 99, "Thief", 5,99, 20, 20);
        assertEquals("testHitNameThief failed", "Thief", thief.getMyCharacterName());
    }

    @Test
    public void testHitNamePriestess() {
        Priestess priestess = new Priestess(50.0, 99, "priestess", 5,99, 20, 20);
        assertEquals("testHitNameThief failed", "priestess", priestess.getMyCharacterName());
    }
    ...
    public void testMaxBlockWarrior() {
        Warrior warrior = new Warrior(50.0, 99, "Warrior", 5,99, 20, 20);
        assertEquals("testMaxBlockWarrior failed", 0, warrior.getMyBlockChance(), 0);
    ...
    public void testMaxBlockThief() {
        Thief thief = new Thief(50.0, 99, "Thief", 5,99, 20, 20);
        assertEquals("testMaxBlockThief failed", 0, thief.getMyBlockChance(), 0);
    }

    @Test
    public void testMaxBlockPriestess() {
        Priestess priestess = new Priestess(50.0, 99, "priestess", 5,99, 20, 20);
        assertEquals("testMaxBlockPriestess failed", 0, priestess.getMyBlockChance(), 0);
    }
    ...
    public void testDeadPriestess() {
        Priestess priestess = new Priestess(0.0, 99, "priestess", 5,99, 20, 20);
